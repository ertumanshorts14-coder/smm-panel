...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Save WhatsApp number to profile
    if (authData.user) {
      await supabase
        .from('profiles')
        .update({ whatsapp })
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#0A0E27] relative overflow-hidden px-4 py-8">
      {/* Aurora glow */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/[0.03] backdrop-blur-lg border border-white/10 rounded-2xl p-6 md:p-8 shadow-2xl">
          ...
          <p className="text-slate-400 text-sm mb-6">Sign up to get started</p>
